...
#t-tests
##self-actualization - importance
report::report(t.test(mean_self_actualization ~ comp_fsi_afi,data = df_centr_asp))
report::report(t.test(mean_self_actualization ~ comp_fsi_sai,data = df_centr_asp))
report::report(t.test(mean_self_actualization ~ comp_fsi_cfi,data = df_centr_asp))

##self-actualization - chances
report::report(t.test(mean_self_actualization ~ comp_fsc_afc,data = df_centr_asp))
report::report(t.test(mean_self_actualization ~ comp_fsc_sac,data = df_centr_asp))
report::report(t.test(mean_self_actualization ~ comp_fsc_cfc,data = df_centr_asp))

##vitality - importance
report::report(t.test(mean_vitality ~ comp_fsi_afi,data = df_centr_asp))
report::report(t.test(mean_vitality ~ comp_fsi_sai,data = df_centr_asp))
report::report(t.test(mean_vitality ~ comp_fsi_cfi,data = df_centr_asp))

##vitality - chances
report::report(t.test(mean_vitality ~ comp_fsc_afc,data = df_centr_asp))
report::report(t.test(mean_vitality ~ comp_fsc_sac,data = df_centr_asp))
report::report(t.test(mean_vitality ~ comp_fsc_cfc,data = df_centr_asp))

##control-orientation - importance
report::report(t.test(mean_control_orientation ~ comp_fsi_afi,data = df_centr_asp))
report::report(t.test(mean_control_orientation ~ comp_fsi_sai,data = df_centr_asp))
report::report(t.test(mean_control_orientation ~ comp_fsi_cfi,data = df_centr_asp))

##control-orientation - chances
report::report(t.test(mean_control_orientation ~ comp_fsc_afc,data = df_centr_asp))
report::report(t.test(mean_control_orientation ~ comp_fsc_sac,data = df_centr_asp))
report::report(t.test(mean_control_orientation ~ comp_fsc_cfc,data = df_centr_asp))

##depressive symptoms - importance
report::report(t.test(mean_depressive_symptoms ~ comp_fsi_afi,data = df_centr_asp))
report::report(t.test(mean_depressive_symptoms ~ comp_fsi_sai,data = df_centr_asp))
report::report(t.test(mean_depressive_symptoms ~ comp_fsi_cfi,data = df_centr_asp))

##depressive symptoms - chances
report::report(t.test(mean_depressive_symptoms ~ comp_fsc_afc,data = df_centr_asp))
report::report(t.test(mean_depressive_symptoms ~ comp_fsc_sac,data = df_centr_asp))
report::report(t.test(mean_depressive_symptoms ~ comp_fsc_cfc,data = df_centr_asp))

##trait anxiety - importance
report::report(t.test(mean_trait_anxiety ~ comp_fsi_afi,data = df_centr_asp))
report::report(t.test(mean_trait_anxiety ~ comp_fsi_sai,data = df_centr_asp))
report::report(t.test(mean_trait_anxiety ~ comp_fsi_cfi,data = df_centr_asp))

##trait anxiety - chances
report::report(t.test(mean_trait_anxiety ~ comp_fsc_afc,data = df_centr_asp))
report::report(t.test(mean_trait_anxiety ~ comp_fsc_sac,data = df_centr_asp))
report::report(t.test(mean_trait_anxiety ~ comp_fsc_cfc,data = df_centr_asp))
```
